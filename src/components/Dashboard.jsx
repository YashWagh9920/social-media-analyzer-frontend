...
const Dashboard = () => {
  ...
  return (
    ...
    onClick={()=> navigate('/chatbot')}
     className="flex items-center gap-2 px-8 py-4 text-2xl rounded-lg text-white bg-gradient-to-r from-indigo-600 to-violet-600 hover:opacity-90 transition-opacity">
